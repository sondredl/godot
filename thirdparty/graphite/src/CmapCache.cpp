...
CachedCmap::~CachedCmap() noexcept
{
    if (!m_blocks) { return;
}
...
uint16 CachedCmap::operator [] (const uint32 usv) const noexcept
{
...
CachedCmap::operator bool() const noexcept
{
    return m_blocks != 0;
}
...
uint16 DirectCmap::operator [] (const uint32 usv) const noexcept
{
    return usv > 0xFFFF
...
DirectCmap::operator bool () const noexcept
{
    return _cmap && _bmp;
}
