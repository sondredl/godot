...
#define png_fixed_ITU(png_ptr, fp, s) ((fp) <= 214748 && (fp) >= 0 ? ((png_uint_32)(10000 * (fp))) : (png_fixed_error(png_ptr, s), 0))
#endif
...
PNG_INTERNAL_FUNCTION(png_uint_32, png_fixed_ITU, (png_const_structrp png_ptr, double fp, png_const_charp text), PNG_EMPTY);
#endif
...
PNG_INTERNAL_FUNCTION(void, png_write_cICP, (png_structrp png_ptr, png_byte colour_primaries, png_byte transfer_function, png_byte matrix_coefficients, png_byte video_full_range_flag), PNG_EMPTY);
#endif

#ifdef PNG_WRITE_cLLI_SUPPORTED
PNG_INTERNAL_FUNCTION(void, png_write_cLLI_fixed, (png_structrp png_ptr, png_uint_32 maxCLL, png_uint_32 maxFALL), PNG_EMPTY);
#endif

#ifdef PNG_WRITE_mDCV_SUPPORTED
PNG_INTERNAL_FUNCTION(void, png_write_mDCV_fixed, (png_structrp png_ptr, png_uint_16 red_x, png_uint_16 red_y, png_uint_16 green_x, png_uint_16 green_y, png_uint_16 blue_x, png_uint_16 blue_y, png_uint_16 white_x, png_uint_16 white_y, png_uint_32 maxDL, png_uint_32 minDL), PNG_EMPTY);
#endif
...
PNG_INTERNAL_FUNCTION(void, png_write_iCCP, (png_structrp png_ptr, png_const_charp name, png_const_bytep profile, png_uint_32 proflen),
		PNG_EMPTY);
...
PNG_INTERNAL_FUNCTION(int, png_icc_check_length, (png_const_structrp png_ptr, png_const_charp name, png_uint_32 profile_length), PNG_EMPTY);
#endif /* READ_iCCP */
PNG_INTERNAL_FUNCTION(int, png_icc_check_header, (png_const_structrp png_ptr, png_const_charp name, png_uint_32 profile_length, png_const_bytep profile /* first 132 bytes only */, int color_type),
		PNG_EMPTY);
PNG_INTERNAL_FUNCTION(int, png_icc_check_tag_table, (png_const_structrp png_ptr, png_const_charp name, png_uint_32 profile_length, png_const_bytep profile /* header plus whole tag table */), PNG_EMPTY);
#endif /* iCCP */
