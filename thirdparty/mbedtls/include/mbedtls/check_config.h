...
#if defined(MBEDTLS_CTR_DRBG_C) && !(defined(MBEDTLS_AES_C) || (defined(MBEDTLS_PSA_CRYPTO_CLIENT) && defined(PSA_WANT_KEY_TYPE_AES) && defined(PSA_WANT_ALG_ECB_NO_PADDING)))
...
#if defined(MBEDTLS_PKCS7_C) && ((!defined(MBEDTLS_ASN1_PARSE_C)) || (!defined(MBEDTLS_OID_C)) || (!defined(MBEDTLS_PK_PARSE_C)) || (!defined(MBEDTLS_X509_CRT_PARSE_C)) || (!defined(MBEDTLS_X509_CRL_PARSE_C)) || (!defined(MBEDTLS_MD_C)))
