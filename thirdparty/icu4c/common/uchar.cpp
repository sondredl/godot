...
_enumTypeRange(const void *context, UChar32 start, UChar32 end, uint32_t value) {
	...
	return static_cast<const _EnumTypeCallback *>(context)->enumRange(static_cast<const _EnumTypeCallback *>(context)->context,
...
u_isgraph(UChar32 c) {
	...
	return (CAT_MASK(props) &
				   (U_GC_CC_MASK | U_GC_CF_MASK | U_GC_CS_MASK | U_GC_CN_MASK | U_GC_Z_MASK)) == 0;
}
...
u_isgraphPOSIX(UChar32 c) {
	...
	/* comparing ==0 returns false for the categories mentioned */
	return (CAT_MASK(props) &
				   (U_GC_CC_MASK | U_GC_CS_MASK | U_GC_CN_MASK | U_GC_Z_MASK)) == 0;
}
