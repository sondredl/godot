...
#define DEFINE_LMBCS_OPEN(n) \
	static void U_CALLCONV   \
			_LMBCSOpen##n(UConverter *_this, UConverterLoadArgs *pArgs, UErrorCode *err) { _LMBCSOpenWorker(_this, pArgs, err, n); }
	...
	*/
	...
	while (args->source < args->sourceLimit && !U_FAILURE(*err)) {
		...
		if ((uniChar >= 0x80) && (uniChar <= 0xff)
				...
				&& (uniChar != 0xB1) && (uniChar != 0xD7) && (uniChar != 0xF7) && (uniChar != 0xB0) && (uniChar != 0xB4) && (uniChar != 0xB6) && (uniChar != 0xA7) && (uniChar != 0xA8)) {
