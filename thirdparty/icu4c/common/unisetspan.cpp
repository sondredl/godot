...
UnicodeSetStringSpan::UnicodeSetStringSpan(const UnicodeSet &set,
		...
		uint32_t which) :
		spanSet(0, 0x10ffff), pSpanNotSet(nullptr), strings(setStrings), utf8Lengths(nullptr), spanLengths(nullptr), utf8(nullptr), utf8Length(0), maxLength16(0), maxLength8(0), all(static_cast<UBool>(which == ALL)) {
...
UnicodeSetStringSpan::UnicodeSetStringSpan(const UnicodeSetStringSpan &otherStringSpan,
		...
		spanSet(otherStringSpan.spanSet), pSpanNotSet(nullptr), strings(newParentSetStrings), utf8Lengths(nullptr), spanLengths(nullptr), utf8(nullptr), utf8Length(otherStringSpan.utf8Length), maxLength16(otherStringSpan.maxLength16), maxLength8(otherStringSpan.maxLength8), all(true) {
